...
ENV KGUARD_AI_ELASTICSEARCH_EXPORT_ENABLED=false
ENV KGUARD_AI_ELASTICSEARCH_URL=http://elasticsearch:9200
ENV KGUARD_AI_ELASTICSEARCH_INDEX=kguard-ai-alerts
